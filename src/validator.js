const validator = {  // funcion que valida la tarjeta de credito
    isValid: (creditCardNumber) => {
      ...
      creditCardNumber = arrayCreditCardNumber.join(''); //.split vuelve a unir los numeros del string y con const definimos creditCarNumber para que este valor no se pueda volver a asignar o declarar, practicamente hace lo contrario a .split.
      ...
      for (let i = 0; i < longitud; i++) {
        ...
        if (i % 2 === 0) {  //genera o identifica los valores pares por el residuo.
        ...
        sumaNumeros = sumaNumeros + numeros;  //Suma todos los numeros de la tarjeta para ser valida
      }
    ...
    maskify: (creditCardNumber) => {
      ...
      return '#'.repeat(longitud - 4) + creditCardNumber.slice(-4); //4 ultimos digitos se mantienen y con .slice hacemos o devolvemos una copia de una parte del array dentro de uno nuevo, ya enmasacarado
    }
  };
